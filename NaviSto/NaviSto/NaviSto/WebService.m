...
+ (void) getLocation: (CLLocation *) location withType: (NSString *) type{
    ...
    NSLog(@"RRRRRR: %f", location.coordinate.longitude);     NSString *data = [NSString stringWithFormat:@"<searchLocationsRequest xmlns=\"%@\" locale=\"%@\" bankCode=\"%@\" keyWord=\"%@\" page=\"%@\" pageSize=\"%@\" lat=\"%f\" lon=\"%f\" type=\"%@\" \/>", @"http://www.mfoundry.com/GBML/Schema", @"en",@"usf",app.bank,@"0",@"10",location.coordinate.latitude,location.coordinate.longitude,type];
